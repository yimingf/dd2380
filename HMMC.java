...
public class HMMC {
    ...
    public static void main( String[] args ) {
        ...
        System.out.println("Difference from correct value for old A");
        printMatrixDistance(_correctA, _oldA);
        System.out.println("A");
        printReadableMatrix(_a);
        System.out.println("Difference from correct value for A");
        printMatrixDistance(_correctA, _a);
        //System.out.println("Difference A");
        //printMatrixDistance(_a,_oldA);

        System.out.println("\nB original");
        printReadableMatrix(_oldB);
        System.out.println("Difference from correct value for old B");
        printMatrixDistance(_correctB, _oldB);
        System.out.println("B");
        printReadableMatrix(_b);
        System.out.println("Difference from correct value for B");
        printMatrixDistance(_correctB, _b);
    ...
    private static void printMatrixDistance(double[][] original, double[][] m2){
        ...
        System.out.println("Total additive distance " + totalDist + " should be 0" );
    }
}